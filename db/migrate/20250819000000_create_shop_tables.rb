...
class CreateShopTables < ActiveRecord::Migration[7.0]
  def change
    ...
    create_table :shop_variants do |t|
      ...
      t.jsonb   :specs, null: false, default: {}  # arbitrary spec values, e.g. size/color
      t.timestamps
    end
    ...
    create_table :shop_orders do |t|
      t.string  :status, null: false, default: "pending" # pending, paid, shipped, cancelled
      t.string  :currency, null: false, default: SiteSetting.shop_currency rescue "CNY"
      ...
      t.string  :address
      t.text    :notes
      t.string  :payment_provider # "wechat", "alipay"
